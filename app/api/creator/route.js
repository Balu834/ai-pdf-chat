...
export async function GET() {
  try {
    ...
    console.error("[creator GET]", err.message);
    return NextResponse.json({ profile: null, stats: {}, agents: [], templates: [], recent_purchases: [] }, { status: 500 });
  }
}
...
export async function POST(req) {
  try {
    ...
    console.error("[creator POST]", err.message);
