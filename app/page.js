...
export default function HomePage() {
  return (
    ...
    >
      ...
      >
        <div
          className="flex items-center justify-between mx-auto px-4 md:px-6"
        ...
        >
          ...
          <div className="flex items-center gap-1">
            {[["#features", "Features"], ["#how-it-works", "How it works"], ["#pricing", "Pricing"]].map(
              ([href, label]) => (
                <a
                  key={label}
                  href={href}
                  className="hidden lg:block text-sm px-3 py-1.5 rounded-lg"
            ...
            <a
              href="/login"
              className="hidden sm:block text-sm font-medium px-3 py-2 rounded-lg"
            ...
            <a
              href="/login"
              className="btn-primary text-xs sm:text-sm font-bold text-white px-4 py-2 rounded-full"
      ...
      >
        ...
        <div className="relative w-full max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          >
            <span
              className="animate-pulse-dot inline-block rounded-full flex-shrink-0"
              style={{ width: 7, height: 7, background: "#a78bfa" }}
            />
            <span className="hidden sm:inline">AI-Powered · </span>Instant Answers from Any PDF
          </div>
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,0.5)", lineHeight: 1.75, maxWidth: 520 }}
          >
            Upload any PDF and get instant answers, summaries, and key insights in seconds.
          </p>
          <p className="animate-fadeUp3 mb-8 text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>
            Invoices · research papers · contracts · study notes
          </p>

          {/* CTA Buttons */}
          <div className="animate-fadeUp4 flex flex-col sm:flex-row gap-3 justify-center items-center mb-4">
            <a
              href="/login"
            ...
            <a
              href="#demo"
              className="w-full sm:w-auto text-sm sm:text-base font-semibold text-center rounded-full transition-all"
              style={{
          ...
          >
            ...
            <div className="flex gap-0.5">
              {[1, 2, 3, 4, 5].map((s) => (
                <span key={s} style={{ color: "#fbbf24" }}>★</span>
              ))}
            </div>
          ...
          >
            ...
            >
              ...
              <span className="ml-2 flex-1 text-center text-xs" style={{ color: "rgba(255,255,255,0.22)" }}>
                intellixy.app — dashboard
              </span>
            </div>
            <div className="flex" style={{ height: 200 }}>
              ...
              <div
                ...
                style={{ width: 155, background: "rgba(0,0,0,0.3)", borderRight: "1px solid rgba(255,255,255,0.06)" }}
              >
                <p className="text-xs font-bold uppercase mb-2" style={{ color: "rgba(255,255,255,0.25)", letterSpacing: "0.1em" }}>
                  Documents
                </p>
                {[["Q4 Report.pdf", true], ["Contract.pdf", false], ["Research.pdf", false]].map(([name, active]) => (
                  <div
                    key={name}
                    className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg mb-1 text-xs truncate"
                    style={{
              ...
              >
                ...
                <div className="flex items-start gap-2">
                  <div
                    ...
                    style={{ width: 24, height: 24, background: "linear-gradient(135deg,#7c3aed,#06b6d4)" }}
                  >
                    <svg width="11" height="11" fill="none" stroke="white" viewBox="0 0 24 24" strokeWidth="2.5">
                  ...
                  >
                    Q4 revenue was <strong style={{ color: "#a78bfa" }}>$4.2M</strong>, up{" "}
                    <strong style={{ color: "#34d399" }}>18%</strong> from Q3.
                    <span
                      className="animate-blink inline-block ml-0.5 align-middle"
                      style={{ width: 5, height: 12, background: "#a78bfa", borderRadius: 2 }}
                    />
                  </div>
                </div>
              </div>
      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto">
          {[
            ...
            { value: "< 2s", label: "Avg response",       color: "#fbbf24" },
          ].map((s) => (
            <div key={s.label}>
              <div className="text-2xl sm:text-3xl md:text-4xl font-black mb-1" style={{ color: s.color, letterSpacing: "-0.5px" }}>
                {s.value}
              </div>
              <div className="text-xs font-medium" style={{ color: "rgba(255,255,255,0.38)" }}>
                {s.label}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <span
              ...
              style={{ color: "#a78bfa", letterSpacing: "0.1em", background: "rgba(124,58,237,0.1)", border: "1px solid rgba(124,58,237,0.2)" }}
            >
              How it works
            </span>
            ...
            <p className="text-base sm:text-lg mx-auto" style={{ color: "rgba(255,255,255,0.4)", maxWidth: 420 }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              { step: "01", icon: "📤", title: "Upload your PDF",     desc: "Drop any PDF — invoices, contracts, research papers, study notes. Any size." },
              ...
              <div
                key={s.step}
                className="card-hover text-center p-6 sm:p-8 rounded-2xl"
              ...
              >
                ...
                <p className="text-sm leading-7" style={{ color: "rgba(255,255,255,0.42)" }}>
                  {s.desc}
                </p>
              </div>
            ))}
      ...
      <section id="features" className="px-4 sm:px-6 py-16 sm:py-24" style={{ background: "rgba(255,255,255,0.012)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <span
              className="inline-block text-xs font-bold uppercase px-4 py-1.5 rounded-full mb-4"
              style={{ color: "#06b6d4", letterSpacing: "0.1em", background: "rgba(6,182,212,0.08)", border: "1px solid rgba(6,182,212,0.2)" }}
            >
              Features
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-4" style={{ letterSpacing: "-0.5px" }}>
              Understand your documents<br className="hidden sm:block" /> like never before
            </h2>
            <p className="text-base sm:text-lg mx-auto" style={{ color: "rgba(255,255,255,0.4)", maxWidth: 460 }}>
            ...
            {[
              {
                ...
                title: "Ask Questions",
                desc: "Get instant answers from your PDFs in plain English — precise and cited.",
                bullets: ["Multi-turn conversation", "Semantic search", "Cited from source"],
              },
              {
                icon: "✨", color: "#06b6d4",
                glow: "rgba(6,182,212,0.1)", border: "rgba(6,182,212,0.25)",
                title: "Smart Summaries",
                desc: "Summarize long documents instantly. Get key points without reading a page.",
                bullets: ["Auto-generated summary", "Key point extraction", "Follow-up suggestions"],
              },
              {
                icon: "🔍", color: "#34d399",
                glow: "rgba(52,211,153,0.08)", border: "rgba(52,211,153,0.22)",
                title: "Key Insights",
                desc: "Extract important points, data, and metrics automatically.",
                bullets: ["Invoice & resume extraction", "Risk detection", "Compare two PDFs"],
              },
            ].map((f) => (
              <div
                key={f.title}
                className="card-hover rounded-2xl p-6 sm:p-8"
                style={{ background: `linear-gradient(135deg,${f.glow},transparent)`, border: `1px solid ${f.border}` }}
              >
                <div
                  className="flex items-center justify-center rounded-2xl mb-5"
                  style={{ width: 52, height: 52, background: f.glow, border: `1px solid ${f.border}`, fontSize: 24 }}
                >
                  {f.icon}
                </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(135deg,rgba(124,58,237,0.12),rgba(6,182,212,0.07))" }}
            />

            {/* Decorative chat bubbles */}
            <div
              className="absolute bottom-4 sm:bottom-7 left-4 sm:left-10 text-xs px-3 sm:px-4 py-2 hidden xs:block"
              style={{
            ...
            <div
              className="absolute top-4 sm:top-7 right-4 sm:right-10 text-xs px-3 sm:px-4 py-2 hidden xs:block"
              style={{
            ...
            <div className="relative flex flex-col items-center gap-3 z-10">
              <a
                ...
                style={{
                  width: 72, height: 72,
                  background: "linear-gradient(135deg,#7c3aed,#06b6d4)",
                  boxShadow: "0 16px 48px rgba(124,58,237,0.5), 0 0 0 14px rgba(124,58,237,0.1)",
                  transition: "transform 0.2s",
                }}
              >
                <svg width="26" height="26" fill="white" viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3" /></svg>
              </a>
              <p className="text-sm font-semibold" style={{ color: "rgba(255,255,255,0.55)" }}>Click to try live</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── TESTIMONIALS ────────────────────────────────────────────────── */}
      <section className="px-4 sm:px-6 py-16 sm:py-24" style={{ background: "rgba(255,255,255,0.012)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <span
              className="inline-block text-xs font-bold uppercase px-4 py-1.5 rounded-full mb-4"
              style={{ color: "#f472b6", letterSpacing: "0.1em", background: "rgba(244,114,182,0.08)", border: "1px solid rgba(244,114,182,0.2)" }}
            >
              Testimonials
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white" style={{ letterSpacing: "-0.5px" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5">
            {[
              { name: "Arjun S.",  role: "Finance Analyst", avatar: "#a78bfa", quote: "I process 20+ invoices daily. Intellixy cuts review time by 70%. I just ask 'total amount' and it pulls it instantly." },
              { name: "Priya M.",  role: "Law Student",     avatar: "#06b6d4", quote: "Perfect for long case files. I ask it to summarize judgments and it gives crisp bullet points in seconds." },
              { name: "Rahul K.", role: "Startup Founder", avatar: "#34d399", quote: "We review contracts before signing. It catches things our team misses. Already saved us from one bad deal." },
            ].map((t) => (
              <div
                key={t.name}
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{ width: 36, height: 36, background: `${t.avatar}22`, border: `2px solid ${t.avatar}55`, color: t.avatar }}
                  >
                    {t.name[0]}
                  </div>
                  <div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 items-start">
            ...
            >
              ...
              <a
                href="/login"
                className="block w-full text-center text-sm font-bold text-white py-3 rounded-xl transition-all"
            ...
            >
              <div
                className="absolute text-xs font-extrabold text-white px-4 py-1.5 rounded-full"
                style={{
      ...
      <section className="px-4 sm:px-6 pb-16 sm:pb-24">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-base sm:text-lg mb-8" style={{ color: "rgba(255,255,255,0.45)", lineHeight: 1.7 }}>
              Free forever. No credit card needed.
            </p>
            <a
              href="/login"
              className="btn-primary inline-block w-full sm:w-auto text-sm sm:text-base font-extrabold text-white text-center rounded-full"
              style={{
                padding: "14px 40px",
                boxShadow: "0 10px 36px rgba(124,58,237,0.45)",
                letterSpacing: "-0.2px",
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.07)", padding: "40px 16px 28px" }}>
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-8 mb-8">
            ...
            <div style={{ maxWidth: 240 }}>
              <div className="flex items-center gap-2 mb-3">
                <div
                  className="flex items-center justify-center rounded-xl flex-shrink-0"
                  style={{ width: 28, height: 28, background: "linear-gradient(135deg,#7c3aed,#06b6d4)" }}
                >
                  <PdfIcon size={13} />
                </div>
            ...
            <div className="flex flex-wrap gap-8 sm:gap-12">
              <div>
                ...
                <div className="flex flex-col gap-2.5">
                  {[["Features", "#features"], ["How it works", "#how-it-works"], ["Pricing", "#pricing"], ["Demo", "#demo"]].map(
                    ([label, href]) => (
              ...
              <div>
                ...
                <div className="flex flex-col gap-2.5">
                  {[
                    ...
                    ["Contact", "mailto:support@intellixy.app"],
                  ].map(([label, href]) => (
                    <a key={label} href={href} className="text-sm" style={{ color: "rgba(255,255,255,0.38)" }}>{label}</a>
                  ))}
                </div>
          ...
          <div
            className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-5"
